...
public class TextBoxManagerLvl5 : MonoBehaviour {
    ...
    public GameObject fAz, fPo, fLe, yAz, yPo, yLe, eAz, ePo, eLe, fraccionHarina, yHarina, enteraHarina, fraccionHuevos, yHuevos, enteraHuevos;
    ...
    void Start()
    {
        ...
        numeroEstrellas.text = (PlayerPrefs.GetInt("estrellasLevel2") + PlayerPrefs.GetInt("estrellasLevel3") + PlayerPrefs.GetInt("estrellasLevel4")).ToString();
    }
    ...
    void textManager()
    {
        ...
        if (currentLine == 4) hint.SetActive(true);

        if (currentLine == 7 && !paused && (Input.GetKeyDown(KeyCode.Return) || Input.GetKeyDown(KeyCode.Space)))
        {
            currentLine += 1;
            return;
        }
        ...
        if (textLines[currentLine].Substring(0, 4).Equals("Yera") && (currentLine != 6) && currentLine != 10 &&
        ...
        if (textLines[currentLine].Substring(0, 4).Equals("Yure") && (currentLine != 6) && currentLine != 10 &&
            currentLine != 12 && currentLine != 14)
        {
            mYera.SetBool("hablando", false);
        ...
        if (!paused && (Input.GetKeyDown(KeyCode.Return) || Input.GetKeyDown(KeyCode.Space)) && (currentLine != 6) && currentLine != 10 &&
            currentLine != 12 && currentLine != 14) currentLine += 1;
    ...
    public void botonCheck()
    {
        ...
        int mantCentV, mantDecV, mantUniV, lecheEntV, lecheNumV, lecheDenV, polvoEntV, polvoNumV, polvoDenV, azucarEntV, azucarNumV, azucarDenV, harinaEntV, harinaNumV, harinaDenV, huevosEntV, huevosNumV, huevosDenV;
        ...
        if (!(mantCentV * 100 + mantDecV * 10 + mantUniV == 80))
        {
        ...
        if (!(polvoEntV == 1 && polvoNumV == 0 && polvoDenV == 0))
        {
        ...
        if (!(huevosEntV == 1 && huevosNumV == 1 && huevosDenV == 3))
        {
        ...
        if (checks == 6)
        {
            ...
            PlayerPrefs.SetInt("failsLevel5", intentos);
            ...
            if (intentos == 0)
            {
                ...
                PlayerPrefs.SetInt("estrellasLevel5", 3);
                return;
            }
            ...
            if (intentos == 1)
            {
                mStar1.SetActive(true);
                mStar2.SetActive(true);
                PlayerPrefs.SetInt("estrellasLevel5", 2);
                return;
            }
            ...
            {
                mStar1.SetActive(true);
                PlayerPrefs.SetInt("estrellasLevel5", 1);
                return;
            }
            PlayerPrefs.SetInt("estrellasLevel5", 0);
        }
        else
        {
            currentLine = 14;
