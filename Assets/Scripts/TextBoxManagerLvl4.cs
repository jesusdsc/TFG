...
public class TextBoxManagerLvl4 : MonoBehaviour {
    ...
    public Text lecheEntera, lecheNumerador, lecheDenominador, mantCent, mantDec, mantUni, azucarEnt, azucarNum, azucarDen, polvoEnt, polvoNum, polvoDen, harinaEnt, harinaNum, harinaDen;
    ...
    public GameObject fAz, fPo, fLe, yAz, yPo, yLe, eAz, ePo, eLe, fraccionHarina, yHarina, enteraHarina;
    ...
    void Start()
    {
        ...
        numeroEstrellas.text = (PlayerPrefs.GetInt("estrellasLevel2") + PlayerPrefs.GetInt("estrellasLevel3")).ToString();
    }
    ...
    void textManager()
    {
        ...
        if (textLines[currentLine].Substring(0, 4).Equals("Yera") && (currentLine != 2) && (currentLine != 4) && currentLine != 15 &&
            currentLine != 17 && currentLine != 20 && currentLine != 23)
        {
            mYera.SetBool("hablando", true);
            mYure.SetBool("hablando", false);
        }

        if (textLines[currentLine].Substring(0, 4).Equals("Yure") && (currentLine != 2) && (currentLine != 4) && currentLine != 15 &&
            currentLine != 17 && currentLine != 20 && currentLine != 23)
        {
            mYera.SetBool("hablando", false);
        ...
        if (!paused && (Input.GetKeyDown(KeyCode.Return) || Input.GetKeyDown(KeyCode.Space)) && (currentLine != 4) && currentLine != 15 &&
            currentLine != 17 && currentLine != 20 && currentLine != 23) currentLine += 1;
    ...
    public void botonCheck()
    {
        ...
        int mantCentV, mantDecV, mantUniV, lecheEntV, lecheNumV, lecheDenV, polvoEntV, polvoNumV, polvoDenV, azucarEntV, azucarNumV, azucarDenV, harinaEntV, harinaNumV, harinaDenV;
        ...
        if (!(mantCentV * 100 + mantDecV * 10 + mantUniV == 200))
        {
        ...
        if (!(polvoEntV == 2 && polvoNumV == 1 && polvoDenV == 2))
        {
        ...
        if (!(lecheEntV == 0 && lecheNumV == 5 && lecheDenV == 6))
        {
        ...
        if (!(azucarEntV == 1 && azucarNumV == 2 && azucarDenV == 3))
        {
        ...
        if (!(harinaEntV == 2 && harinaNumV == 1 && harinaDenV == 2))
        {
        ...
        if (checks == 5)
        {
            ...
            PlayerPrefs.SetInt("failsLevel4", intentos);
            ...
            if (intentos == 0)
            {
                ...
                PlayerPrefs.SetInt("estrellasLevel4", 3);
            ...
            if (intentos == 1)
            {
                mStar1.SetActive(true);
                mStar2.SetActive(true);
                PlayerPrefs.SetInt("estrellasLevel4", 2);
                return;
            }
            ...
            {
                mStar1.SetActive(true);
                PlayerPrefs.SetInt("estrellasLevel4", 1);
                return;
            }
            PlayerPrefs.SetInt("estrellasLevel4", 0);
        }
        else
        {
            currentLine = 17;
